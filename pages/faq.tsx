          ...
          <div className="grid grid-cols-1 mt-12 md:mt-20 md:grid-cols-2 gap-y-16 gap-x-20">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="mt-4 text-base text-gray-400">
                  ...
                  transaction is on one of our supported chains, it should
                  appear soon. In the meantime, you can use your TX hash to
                  track the status on the LayerZero explorer.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="mt-4 text-base text-gray-400">
                  ...
                  available networks are listed in the app, and we&apos;re
                  always working to integrate more.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="mt-4 text-base text-gray-400">
                  Your dashboard displays stats like mints, bridges, streaks,
                  and referrals with XP it earns depending on current
                  progression.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="mt-4 text-base text-gray-400">
                  ...
                  XP for your first interaction each day. When hitting
                  milestones of day 7, 15 and 31 your daily experience will
                  increase.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="mt-4 text-base text-gray-400">
                  Share your referral link to earn extra XP. The more friends
                  you invite, the more XP you earn. Your friend will also earn
                  an additional 100 XP.
                </p>
              </div>
            </div>
            {/* Airdrop */}
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="mt-4 text-base text-gray-400">
                  While we can&rsquo;t confirm any specific plans at this
                  moment, we&rsquo;re always exploring exciting ways to reward
                  our community. Stay tuned for updates; you won&rsquo;t want to
                  miss what&rsquo;s coming!
                </p>
              </div>
            </div>
            {/* Leaderboard Rewards */}
            <div className="flex items-start">
              ...
              <div className="ml-4">
                ...
                <p className="mt-4 text-base text-gray-400">
                  Climbing to the top of the leaderboard won&rsquo;t just earn
                  you bragging rights. We&rsquo;re working on some intriguing
